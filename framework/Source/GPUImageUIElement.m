...
//    CGContextRotateCTM(imageContext, M_PI_2);
    ...
    [outputFramebuffer disableReferenceCounting]; // Add this line, because GPUImageTwoInputFilter.m frametime updatedMovieFrameOppositeStillImage is YES, but the secondbuffer not lock，https://github.com/BradLarson/GPUImage/issues/2211
    ...
    for (id<GPUImageInput> currentTarget in targets)
    {
        if (currentTarget != self.targetToIgnoreForUpdates)
        {
            ...
            [currentTarget setInputFramebuffer:outputFramebuffer atIndex:textureIndexOfTarget]; // add this line, because the outputFramebuffer is update above，https://github.com/BradLarson/GPUImage/issues/2211
